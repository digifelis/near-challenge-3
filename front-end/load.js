...
const payment_amount = "100000000000000000000000";
    ...
    if (wallet.isSignedIn()){
        ...
        console.log(token_id);
            ...
            var response = await contract.nft_mint({
                "token_id": token_id,
                "metadata": {
                        "title": "My Non Fungible Personel Token reber #4143", 
                        "description": "The photo :)", 
                        "media": "https://www.siirt.edu.tr/foto/userfoto/B0539_201362013822811.jpg",
                },
